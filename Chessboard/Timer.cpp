...
//set up menu
  ...
  //printing white values to Timer::lcd and print timer to set up menu
  void Timer::printTimerWhite() {
  ...
  //printing black values to Timer::lcd
  void Timer::printTimerBlack() {
